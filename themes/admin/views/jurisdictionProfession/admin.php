            ...
            $this->widget('bootstrap.widgets.TbGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'filter' => CHtml::activeDropDownList($model, 'profession_type', CHtml::listData(JurisdictionProfessionType::model()->findAll(array('condition' => '', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                        'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Profession Type'),
                    ),
