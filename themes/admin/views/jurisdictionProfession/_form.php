...
<?php echo $form->dropDownListControlGroup($model, 'income_source', CHtml::listData(JurisdictionIncomeSource::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('options' => array('2' => array('selected' => true)), 'class' => 'span5')); ?>
...
<div class="row-fluid">
    <div class="span5">
        ...
        <?php echo JurisdictionProfessionType::get_type_list('JurisdictionProfession', 'profession_type', $model->profession_type); ?>
    </div>
</div>
...
<div class="row-fluid">
    <div class="span5">
        ...
        <?php echo JurisdictionRange::get_range_list('JurisdictionProfession', 'range', $model->range); ?>
    </div>
</div>
<div class="row-fluid">
    <div class="span5">
        <?php echo $form->labelEx($model, 'circle'); ?>
        <?php echo JurisdictionCircle::get_cicle_list('JurisdictionProfession', 'circle', $model->circle); ?>
    </div>
</div>
