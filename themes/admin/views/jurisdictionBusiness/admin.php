...
$this->pageTitle = 'Businesses - ' . Yii::app()->name;
            ...
            $this->widget('bootstrap.widgets.TbGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        'name' => 'business_type',
                        'type' => 'raw',
                        'value' => '$data->businessType->title',
                        'filter' => CHtml::activeDropDownList($model, 'business_type', CHtml::listData(JurisdictionBusinessType::model()->findAll(array('condition' => '', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                        'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Business Type'),
                    ),
