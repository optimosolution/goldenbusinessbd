...
/**
 * This is the model class for table "{{jurisdiction_profession_type}}".
 *
 * The followings are the available columns in table '{{jurisdiction_profession_type}}':
 * @property integer $id
 ...
 * @property JurisdictionProfession[] $jurisdictionProfessions
 * @property JurisdictionIncomeSource $incomeSource
 * @property JurisdictionDistrict $district0
 */
class JurisdictionProfessionType extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return '{{jurisdiction_profession_type}}';
    }
    ...
    public function relations() {
        ...
        return array(
            'jurisdictionProfessions' => array(self::HAS_MANY, 'JurisdictionProfession', 'profession_type'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'district' => 'District',
            'title' => 'Profession Type/ Location of the Profession',
        );
    }
     ...
     * @return JurisdictionProfessionType the static model class
     */
    ...
    public static function get_type_list($controller, $field, $id) {
        $rValue = Yii::app()->db->createCommand()
                ...
                ->from('{{jurisdiction_profession_type}}')
                ->order('title')
                ->queryAll();
