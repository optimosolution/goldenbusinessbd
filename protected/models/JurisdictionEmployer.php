 ...
 * @property JurisdictionService[] $jurisdictionServices
 */
class JurisdictionEmployer extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('tax_employer', 'required'),
            array('tax_employer', 'length', 'max' => 250),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, tax_employer', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'jurisdictionServices' => array(self::HAS_MANY, 'JurisdictionService', 'employer_id'),
        );
    }
