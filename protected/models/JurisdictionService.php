...
/**
 * This is the model class for table "{{jurisdiction_service}}".
 *
 ...
 */
class JurisdictionService extends CActiveRecord {
     ...
     * @return JurisdictionService the static model class
     */
    ...
    public static function get_list_frontend($controller, $field, $id) {
        ...
        foreach ($rValue as $key => $values) {
            if ($values["letter_specific_name"] == $id) {
                echo '<option selected="selected" value="' . $values["letter_specific_name"] . '" class="' . $values["employer_type"] . '">' . $values["letter_specific_name"] . '</option>';
            } else {
                echo '<option value="' . $values["letter_specific_name"] . '" class="' . $values["employer_type"] . '">' . $values["letter_specific_name"] . '</option>';
            }
        }
        echo '</select>';
    }
